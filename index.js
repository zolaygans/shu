...
const config = {
    Z0L4Y: '⚔️ZOLAYBOT⚔️',
    instagram: 'Https://Instagram.com/zolay_31',
    nomer: 'wa.me/+6281999971634',
    aktif: '24 JAM',
    youtube: 'https://youtube.com/channel/UC9Jta2AfRlxpUBd8UNtI0Yg',
    whatsapp: 'https://chat.whatsapp.com/E4KZMUKo8sBAeZfDxnIDIh',
    tanggal: `TANGGAL: ${moment().format('DD')} ${bulan} ${moment().format('YYYY')}`,
    waktu: time
}

const { Z0L4Y, tanggal, waktu, instagram, whatsapp, youtube, nomer, aktif, ontime } = config
...
client.on('message-new', async (m) => {
   ...
   switch (prefix) {
       case 'help':
           client.sendMessage(id, help.help(id, Z0L4Y, tanggal, waktu, whatsapp, youtube, instagram, aktif, nomer, ontime), MessageType.text)
           break
       case 'menu1':
           client.sendMessage(id, menu1.menu1(id, Z0L4Y, tanggal, waktu, whatsapp, youtube, instagram, aktif, nomer, ontime), MessageType.text)
           break
       case 'menu2':
           client.sendMessage(id, menu2.menu2(id, Z0L4Y, tanggal, waktu, whatsapp, youtube, instagram, aktif, nomer, ontime), MessageType.text)
           break
       case 'menu3':
           client.sendMessage(id, menu3.menu3(id, Z0L4Y, tanggal, waktu, whatsapp, youtube, instagram, aktif, nomer, ontime), MessageType.text)
           break
      case 'donate':
           client.sendMessage(id, donate.donate(id, Z0L4Y, tanggal, waktu, whatsapp, youtube, instagram, aktif, nomer, ontime), MessageType.text)
           break          
      case 'info':
           client.sendMessage(id, info.info(id, Z0L4Y, tanggal, waktu, whatsapp, youtube, instagram,aktif, nomer, ontime), MessageType.text)
           break             
       case 'nulis':
           nulis(value)
               .then(data => {
